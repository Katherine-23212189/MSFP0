...
Nombre del alumno: Katherine Coria Camacho
Número de control: 23212189
Correo institucional: l23212189@tectijuana.edu.mx
...
u3 =t/tend
u4 =np.sin(m.pi/2*t)
u = np.column_stack((u1,u2,u3,u4)) #señales de entrada
signals = ['Step','Impulse','Ramp','Sinusoidal'] #nombre de señales de entrada


# Componentes del circuito RLC y función de transferencia
R,L,C = 10E3, 470E-6, 220E-6
num = [1]
den = [L*C, R*C, 1]
sys = ctrl.tf(num,den)
...
#Colores
clr1 = np.array([165,214,167])/255
clr2 = np.array([102,187,106])/255
clr3 = np.array([27,94,32])/255
